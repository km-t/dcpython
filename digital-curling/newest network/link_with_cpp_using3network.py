...
def load_model():
    ...
    model0 = keras.models.load_model('../whereModel.h5', compile=False)
    graph0 = tf.get_default_graph()

    global model1, graph1
    model1 = keras.models.load_model('../angleModel.h5', compile=False)
    graph1 = tf.get_default_graph()

    global model2, graph2
    model2 = keras.models.load_model('../powerModel.h5', compile=False)
